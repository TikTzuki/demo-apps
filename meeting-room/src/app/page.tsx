...
import {TelegramGuideModal} from "@/components/telegram/TelegramGuideModal";
...
export default function HomePage() {
    ...
    return (
        <div className="mx-auto min-h-screen max-w-md px-4 py-8">
            ...
            {/* Add to Discord / Telegram */}
            <div className="mt-8 flex justify-center gap-3">
                <button
                    onClick={() => setTelegramGuideOpen(true)}
                    className="flex items-center gap-2 rounded-full bg-sky-500 px-5 py-2.5 text-sm font-medium text-white transition-colors hover:bg-sky-600"
                >
